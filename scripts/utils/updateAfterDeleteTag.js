 ...
 * 
 */
const updateAfterDeleteTag = (recipesData, mainSearchRecipesToDisplay, recipesToDisplay) => {
  ...
  if (selectedTagsElements.length === 0) {
    ...
    for (let i = 0; i < recipesData.length; i++) {
      // Loop on each value of the arrayOfSelectedTags to see if the value
      // is in the recipes
